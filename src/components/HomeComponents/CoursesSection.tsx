...
const CoursesSection = () => {
  return (
    <div className="lg:container lg:mx-52 ml-[20px] w-full md:mt-16 mt-12 mb-40 px-5 lg:px-[50px] mx-auto ">
      <p className="headline md:text-4xl text-black font-semibold text-[28px]">
        Courses for you
      </p>
      ...
      <div className="grid grid-cols-1 sm:mx-[5px] lg:mx-0 ls:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-2 lg:gap-4 mt-12 place-content-center">
        {courses.map((course, index) => (
          ...
          >
            ...
            />
            <div className="mt-1">
              <p className=" md:text-[22px] text-black font-semibold">
                {course.title}
              </p>
